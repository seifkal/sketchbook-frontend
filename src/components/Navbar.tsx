...
export const navItems = [
    { to: "/", label: "Home", icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/></svg>
    ) },
                    ...
                    <li key={to} className="w-44">
                        <Link
                            ...
                            className={`
                                ...
                                text-left font-medium hover:bg-neutral-800
                                hover:translate-x-1 hover:font-semibold
                                focus:outline-none focus:bg-neutral-800
                                ${location.pathname === to ? "bg-neutral-800 font-semibold" : "text-neutral-200"}
                            `}
                        >
